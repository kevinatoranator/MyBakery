...
public class Tilemap
{
    ...
    public void SetTile(int row, int column, int tilesetID)
    {
    ...
    public void Draw(SpriteBatch spriteBatch, int startX = 0, int startY = 0)
    {
        for(int i = 0; i < Count; i++)
        {
            ...
            int x = i % Columns + startX;
            int y = i / Columns + startY;
